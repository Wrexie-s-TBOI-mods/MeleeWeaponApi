...
<h1 style="text-align:center">~ Concepts ~</h1>

<h3 style="text-align:center">BUZZAXE</h3>

### Active item
>
> - Doesn't charge with room clears, but with time (120s).
> - Holding the items enables stacking **Bloodlust** by killing enemies.
> - **Bloodlust** caps at 100 stacks, decaying over time.
...
>
> - Duration: 15s
> - Switch to melee-only (throwable, see **Buzzaxe Bombardier** below).
...
>
> - During **Buzzaxe Rampge**, gain [The Wafer](https://bindingofisaacrebirth.fandom.com/wiki/The_Wafer)'s effect.
> - During **Buzzaxe Rampge**, get 30 **Bloodlust** stacks per kill.
...
> - Holding the shoot key after a melee attack will throw the **Buzzaxe**, and a new one will appear in Krieg's hands.
>   - This effectively makes Krieg cycle between melee and throw when holding a shoot button/key.
>   - Cycle speed is affected by tear rate.
...
>
> - Killing and enemy triggers an explosion after a 1.5s delay.
> - **Bloodlust** and **Overkill** damage boost the explosion's damage.
...
>
> - You take full heart damage from all sources (even with [The Wafer](https://bindingofisaacrebirth.fandom.com/wiki/The_Wafer)).
> - When you take damage, reduce the cooldown time of Buzzaxe by 20% (`120*0.2 = 24s`).
> - You can take damage from allies (co-op, familiars, etc.).
...
<h3 style="text-align:center">KRIEG</h3>
